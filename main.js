...
function renderSpotlight(c) {
  ...
  document.getElementById('splBrand').textContent = c.brand;
...
document.querySelectorAll('.tcard, .g-item').forEach(el => {
...
const bR = {
  ...
  financing: "Contact Alex directly for bank pre-approval and personalized financing rates. Reach him at +63 912 345 6789.",
